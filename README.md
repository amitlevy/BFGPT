...
BFGPT (**Brute Force GPT**) is an experiment to try and push the power of a GPT chat model a bit further using a large number of attempts and a tangentially related reference for "inspiration".
